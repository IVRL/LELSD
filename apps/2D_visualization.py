...
st.title("2D Visualization of CLIPLSD")
...
semantic_edit_part = st.sidebar.selectbox("Semantic Text", os.listdir(last_path))
...
base_cliplsd_path = os.path.join(last_path, f"{last_date}/model.pth")
...
st.image(editing_image, caption='2D Visualization of CLIPLSD', use_column_width=False)
