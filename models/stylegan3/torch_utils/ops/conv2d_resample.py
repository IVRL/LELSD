...
base_path = base_path[:base_path.find("models/stylegan3/")] + "models/stylegan3"
...
from torch_utils.ops.upfirdn2d import _parse_padding
from torch_utils.ops.upfirdn2d import _get_filter_size
